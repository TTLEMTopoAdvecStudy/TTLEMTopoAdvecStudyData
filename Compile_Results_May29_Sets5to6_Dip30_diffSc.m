...
Kw_over_Ks_list = [2, 5, 10, 2, 5, 10];
Dip_list = [-30, -30, -30, -30, -30, -30];
...
if exist('Compiled_Sets5to6_Dip30_May29_diffSc','dir') == 0
    
    mkdir('Compiled_Sets5to6_Dip30_May29_diffSc');
    
end

Compiled_DIVIDEobj_Analysis_location = [pwd '/Compiled_Sets5to6_Dip30_May29_diffSc'];
