...
if exist('Compiled_DIVIDEobj_Analysis_Sets1to4_Dip30_March22','dir') == 0
    
    mkdir('Compiled_DIVIDEobj_Analysis_Sets1to4_Dip30_March22');
    
end

Compiled_DIVIDEobj_Analysis_location = [pwd '/Compiled_DIVIDEobj_Analysis_Sets1to4_Dip30_March22'];
                ...
                if Use_error_bars ~= 1
                    ...
                    if Set == 1 || Set == 2
                        ...
                        h_mean_dy_dt_vals_LowDiff_HighAdvec = plot(Kw_over_Ks_list(1,Scenario_ref), Slope_temp, ...
                            'marker', char(marker_ref), 'linewidth', 1.5, 'color', color_ref .* 0.5, 'markerfacecolor', color_ref, 'linestyle', 'none');
                        hold on
                        
                    elseif Set == 3 || Set == 4
                        
                        h_mean_dy_dt_vals_LowDiff_LowAdvec = plot(Kw_over_Ks_list(1,Scenario_ref), Slope_temp, ...
                            'marker', char(marker_ref), 'linewidth', 1.5, 'color', color_ref .* 0.5, 'markerfacecolor', color_ref, 'linestyle', char(linestyle_ref));
                        hold on
                ...
                if Use_error_bars ~= 1
                    ...
                    if Set == 1 || Set == 2
                        ...
                        h_mean_dy_dt_vals_HighDiff_HighAdvec = plot(Kw_over_Ks_list(1,Scenario_ref), Slope_temp, ...
                            'marker', char(marker_ref), 'linewidth', 1.5, 'color', color_ref, 'markerfacecolor', 'none', 'linestyle', 'none');
                        hold on
