...
Scenario_list = [9, 10, 11, 13, 14, 15];
Kw_over_Ks_list = [2, 5, 10, 2, 5, 10];
Dip_list = [90, 90, 90, 90, 90, 90];

max_Scenario_HighAdvec = 11;
min_Scenario_LowAdvec = 13;
...
if exist('Compiled_DIVIDEobj_Analysis_Sets5to6_Dip90_May29_95p','dir') == 0
    
    mkdir('Compiled_DIVIDEobj_Analysis_Sets5to6_Dip90_May29_95p');
    
end

Compiled_DIVIDEobj_Analysis_location = [pwd '/Compiled_DIVIDEobj_Analysis_Sets5to6_Dip90_May29_95p'];
