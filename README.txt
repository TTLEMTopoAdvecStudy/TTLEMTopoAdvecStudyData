...
of the article. Sets 1 and 2 in this repository correspond with Sets 9 and 10 in Table 1. Sets 3 and 4 
correspond with Sets 7 and 8 in Table 1. Set 5 contains the simulations for Sets 1, 3, and 5 in Table 1.
Set 6 contains the simulations for Sets 2, 4, and 6 in Table 1.

Sets 1 and 2 use topographic advection rates of vt = 0.5 mm/yr.
Sets 3 and 4 use topographic advection rates of vt = 0.25 mm/yr.
Sets 5 and 6 use topographic advection rates of vt = 0 mm/yr. Simulations in Sets 5 and 6 have different 
contact advection rates (vc): 0.5, 0.25, and 0 mm/yr.

Note that topographic advection rates (vt) and contact advection rates (vc) are in the positive y 
...
For simulation Sets 5 and 6 (which do not include topographic advection), the simulations used include:
