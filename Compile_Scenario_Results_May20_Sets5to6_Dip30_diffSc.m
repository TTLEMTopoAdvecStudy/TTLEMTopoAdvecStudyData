...
y_DD_graphs_min = 0.95;
y_DD_graphs_max = 1.3;

ksn_graphs_min = 0.9;
ksn_graphs_max = 2.2;

Relief_graphs_min = 0.7;
Relief_graphs_max = 1.1;
...
max_Scenario_HighAdvec = 23;
min_Scenario_LowAdvec = 25;
...
if exist('Compiled_DIVIDEobj_Analysis_Sets5to6_Dip30_May20_diffSc','dir') == 0
    
    mkdir('Compiled_DIVIDEobj_Analysis_Sets5to6_Dip30_May20_diffSc');
    
end

Compiled_DIVIDEobj_Analysis_location = [pwd '/Compiled_DIVIDEobj_Analysis_Sets5to6_Dip30_May20_diffSc'];
...
for Set_ref = 1:1:length(Set_list)
    ...
    for Scenario_ref = 1:1:length(Scenario_list)
        ...
        if proceed_test == 1
            ...
            cd([Original_location_ref '/Set' num2str(Set,'%.0f') '_diff_Sc\Output\Scenario_' num2str(Scenario,'%.0f') '/DIVIDEobj_Analysis'])
...
for Iter = 1:2
    ...
    elseif Iter == 2
        ...
        ylim([y_DD_graphs_min, y_DD_graphs_max])
    ...
    elseif Iter == 2
        ...
        ylim([ksn_graphs_min, ksn_graphs_max])
    ...
    elseif Iter == 2
        ...
        ylim([Relief_graphs_min, Relief_graphs_max])
