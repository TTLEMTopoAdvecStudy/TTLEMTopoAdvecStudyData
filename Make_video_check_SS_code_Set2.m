...
if make_elev_plot == 1
    ...
    h_max = semilogy(time_range ./ 1E+06, abs(max_elev_change_percent), 'color', 'r', 'marker', '^', ...
        'linestyle', 'none', 'linewidth', 1);
    hold on
    
    h_mean = semilogy(time_range ./ 1E+06, abs(mean_elev_change_percent), 'color', 'k', 'marker', 'o', ...
        'linestyle', 'none', 'linewidth', 1);
    hold on
    
    h_thresh = semilogy([min_time, max_time] ./ 1E+06, ...
        [percent_z_change_thresh, percent_z_change_thresh], 'color', 'k', 'marker', 'none', ...
