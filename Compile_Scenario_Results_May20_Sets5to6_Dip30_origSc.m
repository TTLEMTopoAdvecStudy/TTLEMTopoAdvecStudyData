...
if exist('Compiled_DIVIDEobj_Analysis_Sets5to6_Dip30_May20_origSc','dir') == 0
    
    mkdir('Compiled_DIVIDEobj_Analysis_Sets5to6_Dip30_May20_origSc');
    
end

Compiled_DIVIDEobj_Analysis_location = [pwd '/Compiled_DIVIDEobj_Analysis_Sets5to6_Dip30_May20_origSc'];
